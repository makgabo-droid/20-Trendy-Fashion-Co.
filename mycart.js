...
// async script is to ensure that both pages are downloading semultaneously with the index.html
...
//the function below confirms the customer's order.
...
//the below function checks if the input is a number
...
//the function below is to update the total in our cart whenever an item is removed from the cart (will alert)
...
//function to display the delivery text area once the button has been clicked
...
//Function for collection 
   ...
   //function for Free Shipping to be added on button click
